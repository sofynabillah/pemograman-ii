  ...
  <div class="container">
    ...
    <div class="row content">
      <div class="d-flex flex-wrap justify-content-start">
          <div class="card m-3 border-primary border-2" style="width: 20rem; border-radius: 20px;">
            <div class="card-body">
              <form action="/groups/addmember/{{ $group->id }}" method="POST">
                ...
                <div class="btn-group mt-5 d-flex flex-wrap justify-content-end">
                  <button type="submit" class="btn btn-primary me-2" style="border-radius: 10px;">Submit</button>
                  <a class="btn btn-outline-danger" href="/groups/#portfolio" style="border-radius: 10px;" role="button">Cancle</a>
                </div>
              </form>
            </div>
