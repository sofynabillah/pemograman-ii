  ...
  <div class="container">
    ...
    <div class="row content">
      <div class="d-flex flex-wrap justify-content-start">
          <div class="card m-3 border-primary border-2" style="width: 20rem; border-radius: 10px;">
            <div class="card-body">
              ...
              <div class="btn-group mt-5 d-flex flex-wrap justify-content-end">
                ...
                <button type="submit" class="btn btn-success me-2" style="border-radius: 10px;">Update</button>
